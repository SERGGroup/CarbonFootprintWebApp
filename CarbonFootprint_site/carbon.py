...
def result():
    if request.method == 'POST':
          ...
          coefficienti={
              ...
              'mediumcar_petrol':0.269/7/float(request.form['passangers_petrol']),
              'mediumcar_diesel':0.229/7/float(request.form['passangers_diesel']),
              'short_flight':0.156/365,
              'long_flight':0.150/365,
              'bus':0.093/7,
              'motorcycle':0.0968/7,
              'electric_vehicle':0.12/7/float(request.form['passangers_electric']),
